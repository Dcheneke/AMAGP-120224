(function() {
  ...
  $rs(document).ready(function($rs) {
    var mySlider, options, regex
      ...
      , arr_of_id = $rs("#cc-slideshow-0d8ed28c .slides_container > [id]").map(function(){
    ...
    $rs("#cc-slideshow-0d8ed28c .slide." + app.configSlideshow().active_slide_class).css('opacity', 1);
    options = {
      container: $rs('#cc-slideshow-0d8ed28c .slides_container').get(0),
      slides: $rs('#cc-slideshow-0d8ed28c .slide').get(),
      autoPlay: $rs("#cc-slideshow-0d8ed28c .slideshow").data('autoplay') || false,
      rotationSpeed: $rs("#cc-slideshow-0d8ed28c .slideshow").data('rotationspeed') || "3500",
      loop: false,
      iterations: $rs("#cc-slideshow-0d8ed28c .slideshow").data('iterations') || Infinity,
      endslide: $rs("#cc-slideshow-0d8ed28c .slideshow").data('endslide'),
      transition: {
        name: $rs("#cc-slideshow-0d8ed28c .slideshow").data('transition') || "default"
      }
    };
    ...
    if ($rs("#cc-slideshow-0d8ed28c .slideshow").data('initial-transition') === true) {
      mySlider.currentSlide = 1;

      mySlider.goTo(0, {name: $rs("#cc-slideshow-0d8ed28c .slideshow").data('transition')});
    ...
    if (!mySlider.status.playing) {
      $rs("#cc-slideshow-0d8ed28c .icon-pause").attr("class", "icon-play-3");
    }

    $rs("#cc-slideshow-0d8ed28c .pause, #cc-slideshow-0d8ed28c .play").click(function(e) {
      var $icon;
      e.preventDefault();
      $icon = $rs(this).find('i');
    ...
    $rs('#cc-slideshow-0d8ed28c [class*="coffee-slider-"]').click(function(e) {
      var command;
      e.preventDefault();
    ...
    mySlider.on("transitionComplete", function() {
      var slides_indicator = $rs('#cc-slideshow-0d8ed28c .slides_indicator')
        , index =$rs('#cc-slideshow-0d8ed28c .slide.' + app.configSlideshow().active_slide_class).index();
    ...
    $rs("a").click(function(e) {
      var id = this.href.match(/#(?:(?!\?).)*/g)
        , index;
      if ($rs(this).is('#cc-slideshow-0d8ed28c .slide_node')) { return goToFromIndicator(e); }
    ...
    swipedetect($rs("#cc-slideshow-0d8ed28c .slides_container")[0], function(direction) {
      switch(direction) {
        case "right":
